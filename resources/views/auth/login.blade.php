            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <div class="logo text-center"><img src="{{asset('assets/img/logoQASautomated.png')}}" alt="Klorofil Logo"></div>
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading">Continuous Testing</h1>
                            <p>by Selenium Java</p>
                        </div>
                    </div>
